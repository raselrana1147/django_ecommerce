# Generated by Django 4.0.1 on 2022-02-26 10:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True, max_length=380, null=True)),
                ('country', models.CharField(blank=True, max_length=191, null=True)),
                ('city', models.CharField(blank=True, max_length=191, null=True)),
                ('zipcode', models.CharField(blank=True, max_length=191, null=True)),
